...
package com.visitek.domino.services.poc.resources;

import static com.visitek.domino.services.poc.json.JsonConstants.HREF_PROP;
import static com.visitek.domino.services.poc.json.JsonConstants.LINKS_PROP;
import static com.visitek.domino.services.poc.json.JsonConstants.REL_PROP;
import static com.visitek.domino.services.poc.service.SampleService.SAMPLE_SERVICE_LOGGER;
...
import com.visitek.domino.services.poc.service.SampleService;

@Path("poc") // $NON-NLS-1$
public class RootResource {
    
    private static final String API_SAMPLE_PATH = "/api/poc"; // $NON-NLS-1$
    private static final String CONTACTS_PATH = "/names.nsf" + API_SAMPLE_PATH + "/contacts"; // $NON-NLS-1$ $NON-NLS-2$
