					...
					<div class="portlet box green-haze">
						...
						<div class="portlet-body form">
								...
								<div class="form-body">	
										...
										<div class="col-md-4">
                                                                                    <input type="hidden" class="form-control" name="approver" id="approver" value= <%=data.getApprover() %>/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control" name="to" id="to" value= <%=data.getTo()%>/>
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-2">Subjects</label>
										<div class="col-md-4">
											<input type="text" class="form-control" name="subjects" id="subjects value=<%=data.getSubject()%> "/>
										</div>
									</div>
									<div class="form-group">
