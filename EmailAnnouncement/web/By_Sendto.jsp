									...
									<div class="form-body">	
										...
										<div class="form-group">
											...
											<div class="col-md-4">
												...
												<option value="AL">Udin Simatupang</option>
				
											</select>
											</div>
											<div class="col-md-4">
												<select class="form-control select2me" data-placeholder="Select...">
												<option value="AL">Harry Potter</option>
												<option value="WY">Voldermolt</option>
											</select>
											</div>
										</div>
									</div>
								...
								<div class="form-actions">
										<div class="row">
											<div class="col-md-offset-3 col-md-9">												
												...
												Cancel <i class="m-icon-swapright m-icon-white"></i>
												</a>
											</div>
										</div>
								</div>
