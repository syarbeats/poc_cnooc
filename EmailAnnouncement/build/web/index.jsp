				...
				<div class="col-md-12">
					...
					<div class="portlet box green-haze">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i>EMail Broadcast Request Application 
							</div>
							<div class="tools">
						...
						<div class="portlet-body form">
                                                    <form class="form-horizontal form-bordered" action="process.jsp" method="POST">
								<div class="form-body">					
									<div class="form-group">
										<label class="control-label col-md-2">Creator</label>
										<div class="col-md-4">
                                                                                    <input type="text" class="form-control" name="creator" id="creator" value="Administrator Jakarta"/>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<textarea name="body" id="body" data-provide="markdown" rows="10"></textarea>
										</div>
									</div>	
								...
								<div class="portlet-body form">
									<div class="form-body">	
										<div class="form-group">
											...
											<div class="col-md-4">
												<label class="control-label col-md-2" font-style="bold">Requestor</label>
											</div>
											<div class="col-md-4">
										...
										<div class="form-group">
											<label class="control-label col-md-2"></label>
											<div class="col-md-4">
                                                                                            <select class="form-control select2me" data-placeholder="Select..." name="requestor">
												<option value="Udin Simatupang">Administrator Jakarta</option>
				
											</select>
											</div>
											<div class="col-md-4">
												<select class="form-control select2me" data-placeholder="Select..." name="approver">
												<option value="Syarbeat/EAI@Ningrat">Syarif Hidayat</option>
												<option value="udin.simatupang/EAI@Ningrat">Udin</option>
											</select>
											</div>
										</div>
									</div>
